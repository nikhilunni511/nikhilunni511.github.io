...
--------------------------------------------------*/
    ...
    $('#btn-less').on('click', ()=> {
      $('#more').addClass('hide');
      $('#btn-less').addClass('hide');
      $('#btn-more').removeClass('hide');
    });

    $('#toggle-btn').on('click', ()=>{
      if($('#bm-navbar').attr('aria-expanded') == undefined || $('#bm-navbar').attr('aria-expanded') == "false"){
        $('.nav-wrapper').addClass('backdrop');
      }else{
        $('.nav-wrapper').removeClass('backdrop');
      }
    });
...
--------------------------------------------*/
    ...
    if (animation) {
      ...
      var text = $('#home .typer-title'),
          textOne = "Hey!!",
          textTwo = "Welcome to &lt;/techKode&gt;",
          textThree = "Want to become Front End Developer?",
          textFour = "Learn core concepts of JavaScript",
          textFive = "JavaScript | ES6 | GIT | Design Pattern | Angular 6+ | Ionic",
          textSix = "WhatsApp @ 9562199511"
          // ,textTwo,textThree, textFour, textFive, textSix
          // JavaScript | ES6 | GIT | Design Pattern | Angular 6+ | Ionic
          if (!!$.prototype.typer) {
...
-------------------------------------------------------------------------*/
    ...
    //   });
    //   el.prepend('<div class="cursor" style="right: initial; left:0;"></div>');
    //   el = el.find(".text-js");
